...
- Public note reading and owner preview prioritize the first markdown image in the rendered article body when it is part of the initial reading viewport; later markdown images remain lazy.
...
- The same loading-intent contract maps prioritized versus lazy image mode across note cards, favicons, and rendered markdown output.
