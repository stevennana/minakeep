...
- In this wave, the settings surface edits:
  - site title
  - site description
  - an owner-controlled SEO debug logging toggle for `/robots.txt` and `/sitemap.xml`
...
## Validation
- The owner can open the settings route and save a new title, description, and SEO debug logging preference.
