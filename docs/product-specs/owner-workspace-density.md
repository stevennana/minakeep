...
- Links, tags, and search stay available from the dashboard as a compact shortcut row inside the Notes surface instead of a separate competing panel.
...
- Dashboard quick access to links, tags, and search remains clear after removing the standalone owner-tools block.
