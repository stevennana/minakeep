...
| `image-loading-strategy.md` | confirmed | viewport-first media loading rules for note images, favicons, and rendered markdown images |
...
| `markdown-reference-link-rendering.md` | confirmed | footnote-style reference-link extraction, fallback rules, and cross-surface note-preview constraints |
